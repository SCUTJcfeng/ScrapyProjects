...
class IdSpider(object):
    def __init__(self):
        super().__init__()
        self.db = pymysql.connect(host='rm-wz9wj90j9qzcfasz6po.mysql.rds.aliyuncs.com', user='root', port=3306, password='qazwsx12!@',
...
if __name__ == '__main__':
    while True:
        r = redis.Redis(host='47.106.136.136', port=6388, password='qazwsx12!@')
